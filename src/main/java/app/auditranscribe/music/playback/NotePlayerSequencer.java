...
public class NotePlayerSequencer extends LoggableClass {
    ...
    /**
     * Initialization method for a <code>NotePlayerSequencer</code> object.<br>
     ...
     */
    public void exportToMIDI(TimeSignature timeSignature, MusicKey key, String outputFilePath) throws IOException {
