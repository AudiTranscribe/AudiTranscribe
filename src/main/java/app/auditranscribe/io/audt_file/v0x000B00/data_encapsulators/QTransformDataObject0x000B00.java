/*
 * QTransformDataObject0x000B00.java
 ...
 */
public class QTransformDataObject0x000B00 extends QTransformDataObject {
    /**
     * Initialization method for the Q-Transform data object.
     *
     * @param qTransformBytes The Q-Transform data as DEFLATE compressed bytes.
     ...
     */
    public QTransformDataObject0x000B00(byte[] qTransformBytes, double minMagnitude, double maxMagnitude) {
     ...
     */
    public QTransformDataObject0x000B00() {
    ...
    public static Triple<Byte[], Double, Double> magnitudesToByteData(double[][] magnitudes, CustomTask<?> task) {
        ...
        // Compress the bytes
        byte[] bytes = CompressionHandlers.deflateCompressFailSilently(plainBytes, task);
    ...
    public static double[][] byteDataToMagnitudes(byte[] bytes, double minMagnitude, double maxMagnitude) {
        ...
        int[][] intData = ByteConversionHandlers.bytesToTwoDimensionalIntegerArray(plainBytes);
