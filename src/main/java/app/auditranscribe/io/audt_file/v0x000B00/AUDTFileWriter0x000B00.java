/*
 * AUDTFileWriter0x000B00.java
 * Description: Handles the writing of the AudiTranscribe file for version 0.11.0.
 *
 ...
 */
public class AUDTFileWriter0x000B00 extends AUDTFileWriter0x000900 {
    /**
     * Initialization method to make an <code>AUDTFileWriter0x000B00</code> object.
     *
     * @param filepath       Path to the AUDT file. The file name at the end of the file path should
     *                       <b>include</b> the extension of the AUDT file.
     * @param numBytesToSkip Number of bytes to skip at the beginning of the file.
     */
    public AUDTFileWriter0x000B00(String filepath, int numBytesToSkip) {
     ...
     *                 <b>include</b> the extension of the AUDT file.
     */
    public AUDTFileWriter0x000B00(String filepath) {
        super(filepath);
    }
    ...
    public void writeAudioData(AudioDataObject object) {
        ...
        AudioDataObject0x000B00 obj = (AudioDataObject0x000B00) object;

        // Write to file
        writeSectionID(AudioDataObject0x000B00.SECTION_ID);
    ...
    public void writeProjectInfoData(ProjectInfoDataObject object) {
        // Cast to the correct version of the object
        ProjectInfoDataObject0x000B00 obj = (ProjectInfoDataObject0x000B00) object;

        // Write to file
        writeSectionID(ProjectInfoDataObject0x000B00.SECTION_ID);
