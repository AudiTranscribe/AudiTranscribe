...
public abstract class AUDTFileWriter extends LoggableClass {
    ...
    protected void writeBoolean(boolean myBoolean) {
        ...
        byte[] byteArray = ByteConversionHandler.booleanToBytes(myBoolean);
    ...
    protected void writeShort(short myShort) {
        // Convert the short into its bytes
        byte[] byteArray = ByteConversionHandler.shortToBytes(myShort);
    ...
    protected void writeInteger(int integer) {
        ...
        byte[] byteArray = ByteConversionHandler.intToBytes(integer);
    ...
    protected void writeDouble(double dbl) {
        ...
        byte[] byteArray = ByteConversionHandler.doubleToBytes(dbl);
    ...
    protected void writeString(String str) {
        ...
        byte[] byteArray = ByteConversionHandler.stringToBytes(str);
    ...
    protected void write1DIntegerArray(int[] array) throws IOException {
        ...
        byte[] byteArray = ByteConversionHandler.oneDimensionalIntegerArrayToBytes(array);
    ...
    protected void write1DDoubleArray(double[] array) throws IOException {
        // Convert the 1D array into its bytes
        byte[] byteArray = ByteConversionHandler.oneDimensionalDoubleArrayToBytes(array);
