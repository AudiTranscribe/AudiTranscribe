 ...
 */
public class MusicNotesDataObject501 extends MusicNotesDataObject {
    /**
     ...
     */
    public MusicNotesDataObject501(double[] timesToPlaceRectangles, double[] noteDurations, int[] noteNums) {
