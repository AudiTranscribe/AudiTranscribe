...
class FrequencyRangeGenerationTest {
    ...
    @Test
    void qTransformFreqBins() {
        // Get the generated frequency bins
        double[] freqBins1 = FrequencyRangeGeneration.qTransformFreqBins(36, 12, 10);
        double[] freqBins2 = FrequencyRangeGeneration.qTransformFreqBins(48, 16, 123.45);
        double[] freqBins3 = FrequencyRangeGeneration.qTransformFreqBins(50, 20, 256.256);
