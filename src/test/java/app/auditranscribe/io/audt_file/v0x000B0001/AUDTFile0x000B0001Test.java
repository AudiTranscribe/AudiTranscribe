...
class AUDTFile0x000B0001Test {
    ...
    AUDTFile0x000B0001Test() throws IOException {
        ...
        // Define data to be used within the tests
        qTransformDataObject = new QTransformDataObject0x000B0001(
                qTransformBytes, minMagnitude, maxMagnitude
        );
        audioDataObject = new AudioDataObject0x000B0001(
        ...
        musicNotesDataObject1 = new MusicNotesDataObject0x000B0001(
                timesToPlaceRectangles1, noteDurations1, noteNums1
        );
        musicNotesDataObject2 = new MusicNotesDataObject0x000B0001(
                timesToPlaceRectangles2, noteDurations2, noteNums2
        );

        unchangingDataPropertiesObject = new UnchangingDataPropertiesObject0x000B0001(
                32 +  // Header section
