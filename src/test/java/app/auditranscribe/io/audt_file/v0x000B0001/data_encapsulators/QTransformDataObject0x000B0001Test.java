...
class QTransformDataObject0x000B0001Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        QTransformDataObject one = new QTransformDataObject0x000B0001(
                qTransformBytes1, minMagnitude1, maxMagnitude1
        );
        QTransformDataObject two = new QTransformDataObject0x000B0001(
    ...
    void testEquals() {
        ...
        QTransformDataObject temp = new QTransformDataObject0x000B0001(
                qTransformBytes1, minMagnitude1, maxMagnitude1
        );
