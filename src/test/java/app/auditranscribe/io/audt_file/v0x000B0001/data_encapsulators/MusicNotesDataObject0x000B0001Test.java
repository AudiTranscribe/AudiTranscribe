...
class MusicNotesDataObject0x000B0001Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        MusicNotesDataObject one = new MusicNotesDataObject0x000B0001(
                timesToPlaceRectangles1, noteDurations1, noteNums1
        );
        MusicNotesDataObject two = new MusicNotesDataObject0x000B0001(
    ...
    void testEquals() {
        ...
        MusicNotesDataObject temp = new MusicNotesDataObject0x000B0001(
                timesToPlaceRectangles1, noteDurations1, noteNums1
        );
