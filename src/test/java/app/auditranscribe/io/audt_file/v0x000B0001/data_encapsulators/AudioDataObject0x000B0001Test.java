...
class AudioDataObject0x000B0001Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        AudioDataObject one = new AudioDataObject0x000B0001(
                compressedOriginalMP3Bytes1, compressedSlowedMP3Bytes1, sampleRate1, totalDurationInMS1
        );
        AudioDataObject two = new AudioDataObject0x000B0001(
    ...
    void testEquals() {
        ...
        AudioDataObject temp = new AudioDataObject0x000B0001(
                compressedOriginalMP3Bytes1, compressedSlowedMP3Bytes1, sampleRate1, totalDurationInMS1
        );
