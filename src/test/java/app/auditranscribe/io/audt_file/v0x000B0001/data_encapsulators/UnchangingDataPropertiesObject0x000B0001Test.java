...
class UnchangingDataPropertiesObject0x000B0001Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        UnchangingDataPropertiesObject one = new UnchangingDataPropertiesObject0x000B0001(numSkippableBytes1);
        UnchangingDataPropertiesObject two = new UnchangingDataPropertiesObject0x000B0001(numSkippableBytes2);
    ...
    void testEquals() {
        ...
        UnchangingDataPropertiesObject temp = new UnchangingDataPropertiesObject0x000B0001(numSkippableBytes1);
        ...
        for (int[] indices1 : indexProduct) {
            UnchangingDataPropertiesObject one = new UnchangingDataPropertiesObject0x000B0001(
                    numSkippableBytes[indices1[0]]
            );

            for (int[] indices2 : indexProduct) {
                UnchangingDataPropertiesObject two = new UnchangingDataPropertiesObject0x000B0001(
