package app.auditranscribe.io.audt_file.v0x000900.data_encapsulators;
...
class ProjectInfoDataObject0x000900Test {
    ...
    void numBytesNeeded() {
        ...
        ProjectInfoDataObject one = new ProjectInfoDataObject0x000900(
                projectName1, musicKeyIndex1, timeSignature1, bpm1, offsetSeconds1, playbackVolume1, currTimeInMS1
        );
        ProjectInfoDataObject two = new ProjectInfoDataObject0x000900(
    ...
    void testEquals() {
        ...
        ProjectInfoDataObject temp = new ProjectInfoDataObject0x000900(
                projectName1, musicKeyIndex1, timeSignature1, bpm1, offsetSeconds1, playbackVolume1, currTimeInMS1
        );
