...
class AUDTFile0x000900Test {
    ...
    static final String FILE_PATH = IOMethods.joinPaths(
            ...
            "test-files","io","audt_file", "v0x000900", "test-AUDTFile0x000900Test.audt"
    );
    ...
    AUDTFile0x000900Test() throws IOException {
        ...
        projectInfoDataObject1 = new ProjectInfoDataObject0x000900(
                "Test-1", 1, TimeSignature.TWO_TWO, 123.45, 0.01,
                0.55, 12
        );
        projectInfoDataObject2 = new ProjectInfoDataObject0x000900(
    ...
    void fileReader_exceptions() {
        ...
        String folder = IOMethods.joinPaths(
                IOConstants.TARGET_FOLDER_ABSOLUTE_PATH, IOConstants.RESOURCES_FOLDER_PATH,
                "test-files", "io", "audt_file", "v0x000900", "AUDTFile0x000900Test"
        );
