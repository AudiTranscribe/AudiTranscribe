...
class AudioDataObject0x000B0002Test {
    // Attributes
    byte[] mp3Bytes1 = new byte[]{(byte) 0x12, (byte) 0x34, (byte) 0x56, (byte) 0x78, (byte) 0x9a};
    byte[] mp3Bytes2 = new byte[]{(byte) 0xab, (byte) 0xcd, (byte) 0xef};
    ...
    void numBytesNeeded() {
        ...
        AudioDataObject one = new AudioDataObject0x000B0002(mp3Bytes1, sampleRate1, totalDurationInMS1);
        AudioDataObject two = new AudioDataObject0x000B0002(mp3Bytes2, sampleRate2, totalDurationInMS2);
    ...
    void testEquals() {
        ...
        AudioDataObject temp = new AudioDataObject0x000B0002(mp3Bytes1, sampleRate1, totalDurationInMS1);
        ...
        for (int[] indices1 : indexProduct) {
            AudioDataObject one = new AudioDataObject0x000B0002(
            ...
            for (int[] indices2 : indexProduct) {
                AudioDataObject two = new AudioDataObject0x000B0002(
