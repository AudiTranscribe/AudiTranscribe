...
class AUDTFile0x000B00Test {
    ...
    static final String FILE_PATH = IOMethods.joinPaths(
            ...
            "test-files", "io", "audt_file", "v0x000B00", "test-AUDTFile0x000B00Test.audt"
    );
    ...
    AUDTFile0x000B00Test() throws IOException {
    ...
    void fileReader_exceptions() {
        ...
        String folder = IOMethods.joinPaths(
                IOConstants.TARGET_FOLDER_ABSOLUTE_PATH, IOConstants.RESOURCES_FOLDER_PATH,
                "test-files", "io", "audt_file", "v0x000B00", "AUDTFile0x000B00Test"
        );
