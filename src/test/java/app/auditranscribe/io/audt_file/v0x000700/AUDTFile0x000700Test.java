...
class AUDTFile0x000700Test {
    ...
    static final String FILE_PATH = IOMethods.joinPaths(
            ...
            "test-files", "io", "audt_file", "v0x000700", "test-AUDTFile0x000700Test.audt"
    );
    ...
    AUDTFile0x000700Test() throws IOException {
    ...
    void fileReader_exceptions() {
        ...
        String folder = IOMethods.joinPaths(
                IOConstants.TARGET_FOLDER_ABSOLUTE_PATH, IOConstants.RESOURCES_FOLDER_PATH,
                "test-files", "io", "audt_file", "v0x000700", "AUDTFile0x000700Test"
        );
