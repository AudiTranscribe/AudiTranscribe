...
class ProjectInfoDataObject0x000700Test {
    ...
    void numBytesNeeded() {
        ...
        ProjectInfoDataObject one = new ProjectInfoDataObject0x000700(
                projectName1, musicKeyIndex1, timeSignatureIndex1, bpm1, offsetSeconds1, playbackVolume1, currTimeInMS1
        );
        ProjectInfoDataObject two = new ProjectInfoDataObject0x000700(
    ...
    void testEquals() {
        ...
        ProjectInfoDataObject temp = new ProjectInfoDataObject0x000700(
                projectName1, musicKeyIndex1, timeSignatureIndex1, bpm1, offsetSeconds1, playbackVolume1, currTimeInMS1
        );
