...
class AUDTFile0x000500Test {
    ...
    static final String FILE_PATH = IOMethods.joinPaths(
            ...
            "test-files","io","audt_file", "v0x000500", "test-AUDTFile0x000500Test.audt"
    );
    ...
    AUDTFile0x000500Test() throws IOException {
        ...
        audioDataObject = new AudioDataObject0x000500(
        ...
        ProjectInfoDataObject0x000500 temp1 = new ProjectInfoDataObject0x000500(
                1, 0, 123.45, 0.01, 0.55, 12
        );
        temp1.setProjectName("VeryShortAudio.mp3");
        projectInfoDataObject1 = temp1;

        ProjectInfoDataObject0x000500 temp2 = new ProjectInfoDataObject0x000500(
    ...
    void fileReader_exceptions() {
        ...
        String folder = IOMethods.joinPaths(
                IOConstants.TARGET_FOLDER_ABSOLUTE_PATH, IOConstants.RESOURCES_FOLDER_PATH,
                "test-files", "io", "audt_file", "v0x000500", "AUDTFile0x000500Test"
        );
