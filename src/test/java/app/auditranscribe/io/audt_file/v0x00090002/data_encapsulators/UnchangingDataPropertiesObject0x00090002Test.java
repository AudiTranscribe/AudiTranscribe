/*
 * UnchangingDataPropertiesObject0x00090002Test.java
 * Description: Test `UnchangingDataPropertiesObject0x00090002.java`.
 *
...
class UnchangingDataPropertiesObject0x00090002Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        UnchangingDataPropertiesObject one = new UnchangingDataPropertiesObject0x00090002(numSkippableBytes1);
        UnchangingDataPropertiesObject two = new UnchangingDataPropertiesObject0x00090002(numSkippableBytes2);
    ...
    void testEquals() {
        ...
        UnchangingDataPropertiesObject temp = new UnchangingDataPropertiesObject0x00090002(numSkippableBytes1);
        ...
        for (int[] indices1 : indexProduct) {
            UnchangingDataPropertiesObject one = new UnchangingDataPropertiesObject0x00090002(
                    numSkippableBytes[indices1[0]]
            );

            for (int[] indices2 : indexProduct) {
                UnchangingDataPropertiesObject two = new UnchangingDataPropertiesObject0x00090002(
