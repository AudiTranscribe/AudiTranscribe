/*
 * QTransformDataObject0x00090002Test.java
 * Description: Test `QTransformDataObject0x00090002.java`.
 *
...
class QTransformDataObject0x00090002Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        QTransformDataObject one = new QTransformDataObject0x00090002(
                qTransformBytes1, minMagnitude1, maxMagnitude1
        );
        QTransformDataObject two = new QTransformDataObject0x00090002(
    ...
    void testEquals() {
        ...
        QTransformDataObject temp = new QTransformDataObject0x00090002(
                qTransformBytes1, minMagnitude1, maxMagnitude1
        );
