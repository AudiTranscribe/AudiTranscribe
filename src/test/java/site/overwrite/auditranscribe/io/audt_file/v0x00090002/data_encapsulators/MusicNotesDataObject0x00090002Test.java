/*
 * MusicNotesDataObject0x00090002Test.java
 * Description: Test `MusicNotesDataObject0x00090002.java`.
 *
...
class MusicNotesDataObject0x00090002Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        MusicNotesDataObject one = new MusicNotesDataObject0x00090002(
                timesToPlaceRectangles1, noteDurations1, noteNums1
        );
        MusicNotesDataObject two = new MusicNotesDataObject0x00090002(
    ...
    void testEquals() {
        ...
        MusicNotesDataObject temp = new MusicNotesDataObject0x00090002(
                timesToPlaceRectangles1, noteDurations1, noteNums1
        );
