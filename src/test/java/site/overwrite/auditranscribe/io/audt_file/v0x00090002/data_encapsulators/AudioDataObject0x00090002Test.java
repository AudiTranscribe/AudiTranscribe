/*
 * AudioDataObject0x00090002Test.java
 * Description: Test `AudioDataObject0x00090002.java`.
 *
...
class AudioDataObject0x00090002Test {
    // Attributes
    ...
    void numBytesNeeded() {
        ...
        AudioDataObject one = new AudioDataObject0x00090002(
                compressedOriginalMP3Bytes1, compressedSlowedMP3Bytes1, sampleRate1, totalDurationInMS1
        );
        AudioDataObject two = new AudioDataObject0x00090002(
    ...
    void testEquals() {
        ...
        AudioDataObject temp = new AudioDataObject0x00090002(
                compressedOriginalMP3Bytes1, compressedSlowedMP3Bytes1, sampleRate1, totalDurationInMS1
        );
