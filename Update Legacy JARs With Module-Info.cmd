...
SET GROUP_IDS[4]=net.harawata
SET GROUP_IDS[5]=org.javatuples
SET GROUP_IDS[6]=org.xerial

SET ARTIFACT_IDS[1]=commons-compress
SET ARTIFACT_IDS[2]=commons-exec
SET ARTIFACT_IDS[3]=commons-lang3
SET ARTIFACT_IDS[4]=appdirs
SET ARTIFACT_IDS[5]=javatuples
SET ARTIFACT_IDS[6]=sqlite-jdbc

SET MODULE_NAMES[1]=org.apache.commons.compress
SET MODULE_NAMES[2]=commons.exec
SET MODULE_NAMES[3]=org.apache.commons.lang3
SET MODULE_NAMES[4]=net.harawata.appdirs
SET MODULE_NAMES[5]=javatuples
SET MODULE_NAMES[6]=org.xerial.sqlitejdbc

SET MODULE_VERSIONS[1]=1.21
SET MODULE_VERSIONS[2]=1.3
SET MODULE_VERSIONS[3]=3.12.0
SET MODULE_VERSIONS[4]=1.2.1
SET MODULE_VERSIONS[5]=1.2
SET MODULE_VERSIONS[6]=3.36.0.3
...
SET MODULE_JARS[4]=appdirs-1.2.1.jar
SET MODULE_JARS[5]=javatuples-1.2.jar
SET MODULE_JARS[6]=sqlite-jdbc-3.36.0.3.jar
